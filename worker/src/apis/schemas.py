...
class ProcessRequest(BaseModel):
    ...
    sidebar_color_hex: str = Field(default="#6366f1", pattern=_HEX_COLOR, description="Sidebar fill color as hex (e.g., #6366f1)")
    ...
    sidebar_transparency: int = Field(default=95, ge=0, le=100, description="Sidebar transparency as percentage (0=opaque, 100=fully transparent)")
